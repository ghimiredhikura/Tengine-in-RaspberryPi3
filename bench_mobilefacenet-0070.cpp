...
const char * text_file="../models/mobilefacenet-0070.prototxt";
const char * model_file="../models/mobilefacenet-0070.caffemodel";
...
{  
   ...
   const char * model_name="mobilefacenet-0070";
   int img_h=112;
   int img_w=112;
